...
export default function VendorList({ basePath, canCreate = true, readOnly = false }: VendorListProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {readOnly ? 'View all vendors (Read Only)' : 'Manage vendor information'}
          </p>
        </div>
        {canCreate && !readOnly && (
          <Button 
                ...
                <TableBody>
                  {vendors.map((vendor) => (
                    <TableRow key={vendor.id}>
                      ...
                      <TableCell className="font-mono text-sm">{vendor.gst_no}</TableCell>
                      <TableCell>
