...
export default function PurchaseManagerDashboard() {
  ...
  useEffect(() => {
    ...
    if (!user || !canAccessRoute(user.role, '/dashboard/purchase-manager')) {
      router.push('/login');
    }
  }, [router]);
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">Purchase Manager Dashboard</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600">Manage and approve vendors</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
